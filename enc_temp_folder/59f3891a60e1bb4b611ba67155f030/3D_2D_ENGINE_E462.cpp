...
// I pledge my honor that I have abided by the Stevens Honor Code - Mason Brewster
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    //These are here bc they won't work in a swithc idk why- Mason Brewster
